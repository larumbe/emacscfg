...
#+BEGIN_SRC emacs-lisp
    (use-package helm-gtags
      :ensure t
      :hook
      (dired-mode-hook . helm-gtags-mode)
...
#+BEGIN_SRC emacs-lisp
  (use-package make-mode
    ...
    :bind
    :hook
    (makefile-mode-hook . linum-mode)
    (makefile-mode-hook . hl-line-mode)
    (makefile-mode-hook . company-mode)
    (makefile-mode-hook . yas-minor-mode)
    (makefile-mode-hook . hs-minor-mode)
    (makefile-mode-hook . rainbow-delimiters-mode)
    (makefile-mode-hook . diff-hl-mode)
    (makefile-mode-hook . superword-mode)
    (makefile-mode-hook . helm-gtags-mode)
    :bind
